...
import/websites/gr.maharashtra.gov.in/Marathi:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Marathi .
...
import: check_env import/websites/gr.maharashtra.gov.in/Marathi .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Marathi import/documents
